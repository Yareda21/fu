        ...
        <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-4 undefined">
          <div className="border border-gray-100 transition-colors duration-200 ease-in-out overflow-hidden rounded-lg bg-blue-700/20 relative ">
            ...
            <div className="p-6">
              ...
              <p>
                Essential courses that anyone pursuing Link career as Link
                professional software engineer should take. Data structures,
                algorithms, design patterns, and more!
              </p>
            </div>
          </div>
          <div className="border border-gray-100 transition-colors duration-200 ease-in-out overflow-hidden rounded-lg bg-blue-700/20 relative ">
            ...
            <div className="p-6">
              ...
              <p>
                All the courses you need to build beautiful websites. HTML, CSS,
          ...
          <div className="border border-gray-100 transition-colors duration-200 ease-in-out overflow-hidden rounded-lg bg-blue-700/20 relative ">
            ...
            <div className="p-6">
              ...
              <p>
                All the courses you need to build powerful APIs for web and
                mobile apps. Node, Django, ASP.NET MVC, MySQL, and more!
              </p>
            </div>
          </div>
          <div className="border border-gray-100 transition-colors duration-200 ease-in-out overflow-hidden rounded-lg bg-blue-700/20 relative ">
            ...
            <div className="p-6">
              ...
              <p>
                All the courses you need to build professional, cross-platform
          ...
          <div className="border border-gray-100 transition-colors duration-200 ease-in-out overflow-hidden rounded-lg bg-blue-700/20 relative ">
            ...
            <div className="p-6">
              <Link
                ...
                href="/p/front-end"
              >
                <h2 className="text-xl mb-0">Data Analysis and AI</h2>
              </Link>
              <p>
                The intersection of data analysis and AI is where the real magic
                happens. using AI to analyze large and complex datasets.
              </p>
            </div>
          </div>
        </div>
